                ...
                { isAddForm() &&
                  (
                    <div className="form-group">
                      ...
                      <input type="text" id="picture" className='form-control' name="picture" value={form.picture.value} onChange={e => handleInputChange(e)}></input>
                      {/* error */}
                      {form.name.error && 
                ...
                <div className="form-group">
                  ...
                  {types.map(type => (
                    <div key={type} style={{marginBottom: '10px'}}>
                      <label>
                        <input id={type} type="checkbox" className="filled-in" value={type} checked={hasType(type)} onChange={e => selectType(type, e)} disabled={!isTypesValide(type)}></input>
                        <span>
